...
FROM
	...
	ON i.Supplier = sup.Supplier AND 
		i.Brand = sup.Supplier 
...
WHERE
	...
	ABS(CorporateMarketAdjustmentPct - ROUND(([ma_base_factor]+[ma_stocking_factor]+[ma_supplier_factor])/FreightAdjPct,4)) > 0.001 
