...
--print('1. export item')
-- 20220603_camsg_Item.txt
select * from msg.item 	

--print('2. export customer')
-- 20220603_camsg_Customer.txt
SELECT * FROM msg.Customer

--print ('3. export sales')
-- 20220603_camsg_Transaction.txt
SELECT * FROM msg.[Transaction] where POSTED_DATE BETWEEN '2022-05-28' and '2022-06-03'
