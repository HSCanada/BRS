...
SELECT 
	...
	,CASE WHEN [SDSOBK_quantity_backordered] = dw.ShippedQty THEN 0 ELSE 1 END as backorder_shipped_ind 
	--
...
-- select distinct QCAC10_division_code FROM [fg].[backorder_FBACKRPT1_history]
