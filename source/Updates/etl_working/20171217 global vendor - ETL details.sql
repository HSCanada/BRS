...
WHERE
	...
	FiscalMonth BETWEEN 202106 AND 202106
GO
...
WHERE
	(BRS_Transaction.FiscalMonth between 202106 AND 202106)
GO
...
WHERE
	...
	(FiscalMonth BETWEEN 202106 AND 202106) AND
	(1=1)
GO
...
-- 3. select & run below
-- [hfm].global_cube_proc  202106, 202106
