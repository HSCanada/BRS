...
WHERE
	...
	FiscalMonth BETWEEN 202203 AND 202203
GO
...
WHERE
	...
	(BRS_Transaction.FiscalMonth BETWEEN 202202 AND 202202)
GO
...
where 
	...
	([NetSalesAmt] <> 0.0) AND
	(BRS_Transaction.FiscalMonth BETWEEN 202202 AND 202202) AND
	(1=1)
GO
...
WHERE
	...
	FiscalMonth BETWEEN 202202 AND 202202 AND
	(1=1)
GO
...
WHERE
	...
	(bu_trans.GLBU_ClassUS_L1 < 'ZZZZZ') AND 
	(BRS_Transaction.global_product_class_key IS NULL) AND 
	(BRS_Transaction.FiscalMonth BETWEEN 201902 AND 202202) AND 
	(1 = 1)
GO
...
-- a_CAN_Feb-22_RA.csv
-- 3. select & run below
-- [hfm].global_cube_new_proc  202202
