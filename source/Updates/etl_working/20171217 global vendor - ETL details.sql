...
WHERE
	...
	FiscalMonth BETWEEN 202212 AND 202212
GO
...
WHERE
	...
	(BRS_Transaction.FiscalMonth BETWEEN 202211 AND 202211)
GO
...
where 
	...
	([NetSalesAmt] <> 0.0) AND
	(BRS_Transaction.FiscalMonth BETWEEN 202211 AND 202211) AND
	(1=1)
GO
...
WHERE
	...
	FiscalMonth BETWEEN 202211 AND 202211 AND
	(1=1)
GO
...
-- 3. select & run below
-- [hfm].global_cube_new_proc  202211
