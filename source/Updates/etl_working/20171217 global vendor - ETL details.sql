...
WHERE
	...
	FiscalMonth BETWEEN 202102 AND 202102
GO
...
WHERE
	(BRS_Transaction.FiscalMonth between 202102 AND 202102)
GO
...
WHERE
	...
	(FiscalMonth BETWEEN 202102 AND 202102) AND
	(1=1)
GO
...
-- 3. select & run below
-- [hfm].global_cube_proc  202102, 202102
