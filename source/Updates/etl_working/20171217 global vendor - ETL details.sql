...
WHERE
	...
	FiscalMonth BETWEEN 202204 AND 202204
GO
...
where 
	...
	([NetSalesAmt] <> 0.0) AND
	(BRS_Transaction.FiscalMonth BETWEEN 202204 AND 202204) AND
	(1=1)
GO
...
WHERE
	...
	FiscalMonth BETWEEN 202204 AND 202204 AND
	(1=1)
GO
...
WHERE
	...
	(bu_trans.GLBU_ClassUS_L1 < 'ZZZZZ') AND 
	(BRS_Transaction.global_product_class_key IS NULL) AND 
	(BRS_Transaction.FiscalMonth BETWEEN 201904 AND 202204) AND 
	(1 = 1)
GO
