...
WHERE
	...
	FiscalMonth BETWEEN 202211 AND 202211
GO
...
WHERE
	...
	(BRS_Transaction.FiscalMonth BETWEEN 202210 AND 202210)
GO
...
where 
	...
	([NetSalesAmt] <> 0.0) AND
	(BRS_Transaction.FiscalMonth BETWEEN 202210 AND 202210) AND
	(1=1)
GO
...
where 
	...
	(BRS_Transaction.FiscalMonth BETWEEN 202209 AND 202209) AND
	(1=1)
GO
...
WHERE
	...
	FiscalMonth BETWEEN 202210 AND 202210
GO
...
WHERE
	...
	FiscalMonth BETWEEN 202210 AND 202210 AND
	(1=1)
GO
...
-- update BRS_ItemCategory!global for new codes first
print '17a. set Global Item Group - AFTER manual maint'
UPDATE       BRS_ItemHistory
...
WHERE
	...
	(BRS_Transaction.FiscalMonth between 202207 AND 202207)
GO
*/
...
-- 3. select & run below
-- [hfm].global_cube_new_proc  202208
