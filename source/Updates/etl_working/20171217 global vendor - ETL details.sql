...
where 
	...
	([NetSalesAmt] <> 0.0) AND
	(BRS_Transaction.FiscalMonth BETWEEN 202205 AND 202205) AND
	(1=1)
GO
...
WHERE
	...
	FiscalMonth BETWEEN 202205 AND 202205 AND
	(1=1)
GO
...
WHERE
	...
	(bu_trans.GLBU_ClassUS_L1 < 'ZZZZZ') AND 
	(BRS_Transaction.global_product_class_key IS NULL) AND 
	(BRS_Transaction.FiscalMonth BETWEEN 201905 AND 202205) AND 
	(1 = 1)
GO
