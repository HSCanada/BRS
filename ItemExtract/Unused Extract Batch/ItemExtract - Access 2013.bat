...
if exist "C:\program files (x86)\Microsoft Office\Office15\MSACCESS.EXE" goto :X64
"C:\Program Files\Microsoft Office\Office15\MSACCESS.EXE" "S:\Shared_Everyone\Business Reporting\Shared\Item Extract\ItemExtract.accdb" /excl /X Import-Export
goto :X86

:X64
"C:\Program Files (x86)\Microsoft Office\Office15\MSACCESS.EXE" "S:\Shared_Everyone\Business Reporting\Shared\Item Extract\ItemExtract.accdb" /excl /X Import-Export
