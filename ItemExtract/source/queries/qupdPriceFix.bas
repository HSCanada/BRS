Operation =4
Option =0
Where ="(((STAGE_BRS_ItemBaseHistory.CalMonth)=0) AND (([Item Master Export].[Sell Prc B"
    "rk1])<>[CorporatePrice])) OR (((STAGE_BRS_ItemBaseHistory.CalMonth)=0) AND (([It"
    "em Master Export].[Sell Qty Brk2])<>[SellQtyBrk2])) OR (((STAGE_BRS_ItemBaseHist"
    "ory.CalMonth)=0) AND (([Item Master Export].[Sell Prc Brk2])<>[SellPrcBrk2])) OR"
    " (((STAGE_BRS_ItemBaseHistory.CalMonth)=0) AND (([Item Master Export].[Sell Qty "
    "Brk3])<>[SellQtyBrk3])) OR (((STAGE_BRS_ItemBaseHistory.CalMonth)=0) AND (([Item"
    " Master Export].[Sell Prc Brk3])<>[SellPrcBrk3]))"
Begin InputTables
