--------------------------------------------------------------------------------
-- new
-- DROP table [Integration].[F4101_item_master_Staging]
-- TRUNCATE table [Integration].[F4101_item_master_Staging]
--------------------------------------------------------------------------------
...
SELECT 
 ...
 INTO [Integration].[F4101_item_master_Staging]
...
ALTER TABLE Integration.F4101_item_master_Staging ADD CONSTRAINT
	F4101_item_master_Staging_pk PRIMARY KEY NONCLUSTERED 
	(
