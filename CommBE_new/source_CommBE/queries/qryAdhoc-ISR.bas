Operation =1
Option =0
Where ="(((comm_transaction_F555115.FiscalMonth)=202203) AND ((comm_transaction_F555115."
    "isr_salesperson_key_id)=\"amanda.yip\") AND ((comm_transaction_F555115.source_cd"
    ")<>\"IMP\"))"
Begin InputTables
...
Begin OutputColumns
    ...
    Expression ="comm_transaction_F555115.isr_comm_amt"
