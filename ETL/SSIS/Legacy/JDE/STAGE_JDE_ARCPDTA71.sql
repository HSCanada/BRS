...
--    Top 5 
	...
	"ADUOM" AS ADUOM__um,
	"ADMNQ" AS ADMNQ__quantity_from,"ADEFTJ" AS ADEFTJ_effective_date,
...
ADTDAY
	...
	FROM
		ARCPDTA71.F4072
    WHERE
		ADEFTJ <= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3)) AND 		
		ADEXDJ >= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3))  		
--    ORDER BY
...
'
	...
	FROM
		ARCPDTA71.F41061
    WHERE
		CBEFTJ <= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3)) AND 		
		CBEXDJ >= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3))  		
--    ORDER BY
--        <insert custom code here>
')
...
'
	...
	FROM
		ARCPDTA71.F554070
    WHERE
		QNEFTJ <= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3)) AND 		
		QNEXDJ >= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3))  		
--    ORDER BY
--        <insert custom code here>
')
...
--    Top 5 
--    "SHKCOO" AS SHKCOO_order_company,
"SHDOCO" AS SHDOCO_salesorder_number,
"SHDCTO" AS SHDCTO_order_type,
"SHSFXO" AS SHSFXO_order_suffix,
"SHMCU" AS SHMCU__business_unit,
"SHCO" AS SHCO___company,
"SHOKCO" AS SHOKCO_original_order_document_company,
"SHOORN" AS SHOORN_original_order_number,
"SHOCTO" AS SHOCTO_original_order_type,
"SHRKCO" AS SHRKCO_related_order_key_company,
"SHRORN" AS SHRORN_related_order_number,
"SHRCTO" AS SHRCTO_related_order_type,
"SHAN8" AS SHAN8__billto,
"SHSHAN" AS SHSHAN_shipto,
"SHPA8" AS SHPA8__parent_number,
"SHDRQJ" AS SHDRQJ_requested,
"SHTRDJ" AS SHTRDJ_order_date,
"SHPDDJ" AS SHPDDJ_scheduled_pick,
"SHOPDJ" AS SHOPDJ_original_promised,
"SHADDJ" AS SHADDJ_actual_ship,
"SHCNDJ" AS SHCNDJ_cancel_date,
"SHPEFJ" AS SHPEFJ_price_effective,
"SHPPDJ" AS SHPPDJ_ship,
"SHPSDJ" AS SHPSDJ_projected_available,
"SHVR01" AS SHVR01_reference,
"SHVR02" AS SHVR02_reference_2,
"SHDEL1" AS SHDEL1_delivery_instructions,
"SHDEL2" AS SHDEL2_delivery_instructions,
"SHINMG" AS SHINMG_print_message,
"SHPTC" AS SHPTC__payment_terms,
"SHRYIN" AS SHRYIN_payment_instrument,
"SHASN" AS SHASN__adjustment_schedule,
"SHPRGP" AS SHPRGP_pricing_group,
"SHTRDC" AS SHTRDC_trade_discount,
"SHPCRT" AS SHPCRT_retainage_pct,
"SHTXA1" AS SHTXA1_tax_ratearea,
"SHEXR1" AS SHEXR1_tax_expl_code,
"SHTXCT" AS SHTXCT_certificate,
"SHATXT" AS SHATXT_associated_text,
"SHPRIO" AS SHPRIO_priority_processing_code,
"SHBACK" AS SHBACK_backorders_allowed_yn,
"SHSBAL" AS SHSBAL_substitutes_allowed_yn,
"SHHOLD" AS SHHOLD_hold_orders_code,
"SHPLST" AS SHPLST_price_pick_list_yn,
"SHINVC" AS SHINVC_invoice_copies,
"SHNTR" AS SHNTR__nature_of_transaction,
"SHANBY" AS SHANBY_buyer_number,
"SHCARS" AS SHCARS_carrier_number,
"SHMOT" AS SHMOT__mode_of_trn,
"SHCOT" AS SHCOT__conditions_of_transport,
"SHROUT" AS SHROUT_route_code,
"SHSTOP" AS SHSTOP_stop_code,
"SHZON" AS SHZON__zone_number,
"SHCNID" AS SHCNID_container_id,
"SHFRTH" AS SHFRTH_freight_handling_code,
"SHAFT" AS SHAFT__apply_freight_yn,
"SHFUF1" AS SHFUF1_aia_document,
"SHFRTC" AS SHFRTC_freight_calculated_yn,
"SHMORD" AS SHMORD_merge_orders_yn,
"SHCMC1" AS SHCMC1_commission_code_1,
"SHCMR1" AS SHCMR1_commission_rate_1,
"SHCMC2" AS SHCMC2_commission_code_2,
"SHCMR2" AS SHCMR2_commission_rate_2,
"SHRCD" AS SHRCD__reason_code,
"SHFUF2" AS SHFUF2_post_quantities,
"SHOTOT" AS SHOTOT_order_gross_amount,
"SHTOTC" AS SHTOTC_total_cost,
"SHWUMD" AS SHWUMD_weight_display_um,
"SHVUMD" AS SHVUMD_volume_display_um,
"SHAUTN" AS SHAUTN_authorization_number_credit_approval,
"SHCACT" AS SHCACT_creditbank_account_number,
"SHCEXP" AS SHCEXP_expired_date_creditbank_acct,
"SHSBLI" AS SHSBLI_subledger_inactive_code,
"SHCRMD" AS SHCRMD_send_method,
"SHCRRM" AS SHCRRM_mode_f,
"SHCRCD" AS SHCRCD_currency_code,
"SHCRR" AS SHCRR__exchange_rate,
"SHLNGP" AS SHLNGP_language,
"SHFAP" AS SHFAP__foreign_open_amount,
"SHFCST" AS SHFCST_foreign_total_cost,
"SHORBY" AS SHORBY_ordered_by,
"SHTKBY" AS SHTKBY_order_taken_by,
"SHURCD" AS SHURCD_user_reserved_code,
"SHURDT" AS SHURDT_user_reserved_date,
"SHURAT" AS SHURAT_user_reserved_amount,
"SHURAB" AS SHURAB_user_reserved_number,
"SHURRF" AS SHURRF_user_reserved_reference,
"SHUSER" AS SHUSER_user_id,
"SHPID" AS SHPID__program_id,
"SHJOBN" AS SHJOBN_work_station_id,
"SHUPMJ" AS SHUPMJ_date_updated,
"SHTDAY" AS SHTDAY_time_of_day 
...
SHSHAN,
SHPA8,
CASE WHEN SHDRQJ IS NOT NULL THEN DATE(DIGITS(DEC(SHDRQJ+ 1900000,7,0))) ELSE NULL END AS SHDRQJ,
CASE WHEN SHTRDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHTRDJ+ 1900000,7,0))) ELSE NULL END AS SHTRDJ,
CASE WHEN SHPDDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHPDDJ+ 1900000,7,0))) ELSE NULL END AS SHPDDJ,
CASE WHEN SHOPDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHOPDJ+ 1900000,7,0))) ELSE NULL END AS SHOPDJ,
CASE WHEN SHADDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHADDJ+ 1900000,7,0))) ELSE NULL END AS SHADDJ,
CASE WHEN SHCNDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHCNDJ+ 1900000,7,0))) ELSE NULL END AS SHCNDJ,
CASE WHEN SHPEFJ IS NOT NULL THEN DATE(DIGITS(DEC(SHPEFJ+ 1900000,7,0))) ELSE NULL END AS SHPEFJ,
CASE WHEN SHPPDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHPPDJ+ 1900000,7,0))) ELSE NULL END AS SHPPDJ,
CASE WHEN SHPSDJ IS NOT NULL THEN DATE(DIGITS(DEC(SHPSDJ+ 1900000,7,0))) ELSE NULL END AS SHPSDJ,
SHVR01,
SHVR02,
SHDEL1,
SHDEL2,
...
SHASN,
SHPRGP,
CAST((SHTRDC)/1000.0 AS DEC(15,3)) AS SHTRDC,
CAST((SHPCRT)/1000.0 AS DEC(15,3)) AS SHPCRT,
SHTXA1,
SHEXR1,
SHTXCT,
SHATXT,
...
SHMORD,
SHCMC1,
CAST((SHCMR1)/1000.0 AS DEC(15,3)) AS SHCMR1,
SHCMC2,
CAST((SHCMR2)/1000.0 AS DEC(15,3)) AS SHCMR2,
SHRCD,
SHFUF2,
CAST((SHOTOT)/100.0 AS DEC(15,2)) AS SHOTOT,
CAST((SHTOTC)/100.0 AS DEC(15,2)) AS SHTOTC,
SHWUMD,
SHVUMD,
SHAUTN,
SHCACT,
CASE WHEN SHCEXP IS NOT NULL THEN DATE(DIGITS(DEC(SHCEXP+ 1900000,7,0))) ELSE NULL END AS SHCEXP,
SHSBLI,
SHCRMD,
SHCRRM,
SHCRCD,
SHCRR,
SHLNGP,
CAST((SHFAP)/100.0 AS DEC(15,2)) AS SHFAP,
CAST((SHFCST)/100.0 AS DEC(15,2)) AS SHFCST,
SHORBY,
SHTKBY,
SHURCD,
CASE WHEN SHURDT IS NOT NULL THEN DATE(DIGITS(DEC(SHURDT+ 1900000,7,0))) ELSE NULL END AS SHURDT,
CAST((SHURAT)/100.0 AS DEC(15,2)) AS SHURAT,
SHURAB,
SHURRF,
SHUSER,
SHPID,
SHJOBN,
CASE WHEN SHUPMJ IS NOT NULL THEN DATE(DIGITS(DEC(SHUPMJ+ 1900000,7,0))) ELSE NULL END AS SHUPMJ,
SHTDAY
...
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3)) AND 		
		...
		SDDGL >= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE)-7)),8,3)) AND 		
		SDDGL <= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)),
SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3)) 
--    ORDER BY
--        <insert custom code here>
...
SELECT 
    ...
    Top 5 
    "IVAN8" AS IVAN8__billto,
"IVXRT" AS IVXRT__cross_reference_type_code,
"IVITM" AS IVITM__item_number_short,
"IVEXDJ" AS IVEXDJ_expired_date,
"IVEFTJ" AS IVEFTJ_effective_date,
"IVMCU" AS IVMCU__business_unit,
"IVCITM" AS IVCITM_customersupplier_item_number,
"IVDSC1" AS IVDSC1_description,
"IVDSC2" AS IVDSC2_description_2,
"IVALN" AS IVALN__search_text_compressed,
"IVLITM" AS IVLITM_item_number,
"IVAITM" AS IVAITM__3rd_item_number,
"IVURCD" AS IVURCD_user_reserved_code,
"IVURDT" AS IVURDT_user_reserved_date,
"IVURAT" AS IVURAT_user_reserved_amount,
"IVURAB" AS IVURAB_user_reserved_number,
"IVURRF" AS IVURRF_user_reserved_reference,
"IVUSER" AS IVUSER_user_id,
"IVPID" AS IVPID__program_id,
"IVJOBN" AS IVJOBN_work_station_id,
"IVUPMJ" AS IVUPMJ_date_updated,
"IVTDAY" AS IVTDAY_time_of_day 
...
IVXRT,
IVITM,
CASE WHEN IVEXDJ IS NOT NULL THEN DATE(DIGITS(DEC(IVEXDJ+ 1900000,7,0))) ELSE NULL END AS IVEXDJ,
CASE WHEN IVEFTJ IS NOT NULL THEN DATE(DIGITS(DEC(IVEFTJ+ 1900000,7,0))) ELSE NULL END AS IVEFTJ,
IVMCU,
IVCITM,
IVDSC1,
IVDSC2,
...
IVAITM,
IVURCD,
CASE WHEN IVURDT IS NOT NULL THEN DATE(DIGITS(DEC(IVURDT+ 1900000,7,0))) ELSE NULL END AS IVURDT,
CAST((IVURAT)/100.0 AS DEC(15,2)) AS IVURAT,
IVURAB,
IVURRF,
IVUSER,
IVPID,
IVJOBN,
CASE WHEN IVUPMJ IS NOT NULL THEN DATE(DIGITS(DEC(IVUPMJ+ 1900000,7,0))) ELSE NULL END AS IVUPMJ,
IVTDAY
...
SELECT 
    ...
    Top 5 
    "GIDOCO" AS GIDOCO_salesorder_number,
"GIDCTO" AS GIDCTO_order_type,
"GIKCOO" AS GIKCOO_order_company,
"GILNID" AS GILNID_line_number,
"GI$ANT" AS GI$ANT_address_number_type,
"GI$SPS" AS GI$SPS_sequence_number_ship,
"GIMLNM" AS GIMLNM_mailing_name,
"GIADD1" AS GIADD1_address_line_1,
"GIADD2" AS GIADD2_address_line_2,
"GIADD3" AS GIADD3_address_line_3,
"GIADD4" AS GIADD4_address_line_4,
"GIADDZ" AS GIADDZ_postal_code,
"GICTY1" AS GICTY1_city,
"GICOUN" AS GICOUN_county,
"GIADDS" AS GIADDS_state,
"GICTR" AS GICTR__country,
"GI$TCN" AS GI$TCN_number_transportation_control,
"GI$DRN" AS GI$DRN_number_dock_receiver,
"GI$TPC" AS GI$TPC_code_transportation_priority,
"GI$FFY" AS GI$FFY_fleet_fast_pay,
"GIUSER" AS GIUSER_user_id,
"GIPID" AS GIPID__program_id,
"GIJOBN" AS GIJOBN_work_station_id,
"GIUPMJ" AS GIUPMJ_date_updated,
"GITDAY" AS GITDAY_time_of_day 
...
GIDCTO,
GIKCOO,
CAST((GILNID)/1000.0 AS DEC(15,3)) AS GILNID,
GI$ANT,
GI$SPS,
GIMLNM,
GIADD1,
...
GIPID,
GIJOBN,
CASE WHEN GIUPMJ IS NOT NULL THEN DATE(DIGITS(DEC(GIUPMJ+ 1900000,7,0))) ELSE NULL END AS GIUPMJ,
GITDAY
...
--------------------------------------------------------------------------------
-- DROP TABLE STAGE_JDE_ARCPDTA71_F55049_contract_members_set_list
--------------------------------------------------------------------------------
...
--    Top 5 
    "CMASN" AS CMASN__adjustment_schedule,
	"CMAST" AS CMAST__adjustment_name,
	"CMURAB" AS CMURAB_user_reserved_number,
	"CMITM" AS CMITM__item_number_short,
	"CMLITM" AS CMLITM_item_number,
	"CMCITM" AS CMCITM_customersupplier_item_number,
	"CMPRGR" AS CMPRGR_item_price_group,
	"CMDSC1" AS CMDSC1_description,
	"CMUOM1" AS CMUOM1_unit_of_measure,
	"CMCKAV" AS CMCKAV_check_availability_yn,
	"CM$SZE" AS CM$SZE_size_packaged_units,
	"CM$STR" AS CM$STR_strength,
	"CMEFTJ" AS CMEFTJ_effective_date,
	"CMEXDJ" AS CMEXDJ_expired_date,
	"CMCQTY" AS CMCQTY_current_lot_quantity,
	"AJFVTR" AS AJFVTR_factor_value,
	"CMFVTR" AS CMFVTR_factor_value,
	"CMUPRC" AS CMUPRC_unit_price,
	"CPFVTR" AS CPFVTR_factor_value,
	"CMMNQ" AS CMMNQ__quantity_from,
	"BPFVTR" AS BPFVTR_factor_value,
	"FLUNCS" AS FLUNCS_unit_cost,
	"AVUNCS" AS AVUNCS_unit_cost,
	"LDUNCS" AS LDUNCS_unit_cost,
	"CMUNCS" AS CMUNCS_unit_cost,
	"CTUNCS" AS CTUNCS_unit_cost,
	"CM$NCT" AS CM$NCT_new_cost,
	"CM$STU" AS CM$STU_status,
	"CMSRP1" AS CMSRP1_sales_catalog_section,
	"CMDSC" AS CMDSC__um_description,
	"CMSRP2" AS CMSRP2_sub_section,
	"CMDSC2" AS CMDSC2_description_2,
	"CMSRP3" AS CMSRP3_sales_category_code_3,
	"CMDSC3" AS CMDSC3_description_line_3,
	"CMCYCL" AS CMCYCL_cycle_count_category,
	"CM$CN2" AS CM$CN2_contract_number,
	"CM$EON" AS CM$EON_manufacturers_external_contract_number,
	"CMSRP5" AS CMSRP5_sales_category_code_5,
	"CMSRP6" AS CMSRP6_category_code_6,
	"CMSRP8" AS CMSRP8_category_code_8,
	"CMSRP7" AS CMSRP7_category_code_7,
	"CMSTKT" AS CMSTKT_stocking_type,
	"CMUITM" AS CMUITM_item_number,
	"CM$CLC" AS CM$CLC_classification_code,
	"CM$LCT" AS CM$LCT_location_type,
	"CMDS01" AS CMDS01_description,
	"CM$ENT" AS CM$ENT_entity_code,
	"CM$DTE" AS CM$DTE_date,
	"CMDESC" AS CMDESC_description,
	"CMPLAN" AS CMPLAN_plan_id 

INTO 
	STAGE_JDE_ARCPDTA71_F55049_contract_members_set_list
...
'
	...
	SELECT
		...
		CM$SZE,
		CM$STR,
		DATE(DIGITS(DEC(CMEFTJ+ 1900000,7,0))) AS CMEFTJ,
		DATE(DIGITS(DEC(CMEXDJ+ 1900000,7,0))) AS CMEXDJ,
		CMCQTY,
		CAST((AJFVTR)/10000.0 AS DEC(15,4)) AS AJFVTR,
		CAST((CMFVTR)/10000.0 AS DEC(15,4)) AS CMFVTR,
		CAST((CMUPRC)/10000.0 AS DEC(15,4)) AS CMUPRC,
		CAST((CPFVTR)/10000.0 AS DEC(15,4)) AS CPFVTR,
		CMMNQ,
		CAST((BPFVTR)/10000.0 AS DEC(15,4)) AS BPFVTR,
		CAST((FLUNCS)/10000.0 AS DEC(15,4)) AS FLUNCS,
		CAST((AVUNCS)/10000.0 AS DEC(15,4)) AS AVUNCS,
		CAST((LDUNCS)/10000.0 AS DEC(15,4)) AS LDUNCS,
		CAST((CMUNCS)/10000.0 AS DEC(15,4)) AS CMUNCS,
		CAST((CTUNCS)/10000.0 AS DEC(15,4)) AS CTUNCS,
		CAST((CM$NCT)/10000.0 AS DEC(15,4)) AS CM$NCT,
		CM$STU,
		CMSRP1,
		CMDSC,
		CMSRP2,
	...
	FROM
		ARCPDTA71.F55049
    WHERE
		CMEFTJ <= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)), SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3)) AND
		CMEXDJ >= CONCAT(CONCAT(''1'',SUBSTR(CHAR(YEAR(CURRENT DATE)),3,2)), SUBSTR(CHAR(DIGITS(DAYOFYEAR(CURRENT DATE))),8,3))
--    ORDER BY
--        <insert custom code here>
')
