...
Begin Report
    ...
    RecSrcDt = Begin
        0xe47df43e75a3e340
    End
    RecordSource ="qryCommESSStatementDetailReport"
        ...
        Begin PageHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="Text153"
                    ControlSource ="=\"HSC ESS Sales & Commission Details - \" & [fiscal_begin_dt] & \"-\" & [fiscal"
                        "_end_dt]"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Width =11430
                    Height =547
                    Name ="subrptCommESS-Summary"
                    SourceObject ="Report.subrptCommESS-Summary"
                    LinkChildFields ="salesperson_key_id"
                    LinkMasterFields ="salesperson_key_id"
                    EventProcPrefix ="subrptCommESS_Summary"

                    LayoutCachedTop =540
                    LayoutCachedWidth =11430
                    LayoutCachedHeight =1087
                End
                Begin Subform
                    Top =1140
                    Width =11415
                    Height =479
                    TabIndex =1
                    Name ="subrptCommESS-Import-Rebates"
                    SourceObject ="Report.subrptCommESS-Import-Total"
                    LinkChildFields ="salesperson_key_id"
                    LinkMasterFields ="salesperson_key_id"
                    EventProcPrefix ="subrptCommESS_Import_Rebates"
