Operation =1
Option =0
Where ="(((comm_customer_free_goods_YTD.fiscal_yearmo_num)>=\"201901\") AND ((comm_custo"
    "mer_free_goods_YTD.salesperson_ess_cd)=\"ESS75\") AND ((comm_customer_free_goods"
    "_YTD.doc_id)=\"12239760\"))"
Begin InputTables
