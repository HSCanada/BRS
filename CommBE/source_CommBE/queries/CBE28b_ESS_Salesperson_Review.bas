...
dbMemo "OrderBy" ="[CBE28b_ESS_Salesperson_Review].[master_salesperson_cd], [CBE28b_ESS_Salesperson"
    "_Review].[territory_start_dt], [CBE28b_ESS_Salesperson_Review].[branch_cd], [CBE"
    "28b_ESS_Salesperson_Review].[comm_plan_id], [CBE28b_ESS_Salesperson_Review].[emp"
    "loyee_num], [CBE28b_ESS_Salesperson_Review].[salesperson_nm]"
Begin
    Begin
