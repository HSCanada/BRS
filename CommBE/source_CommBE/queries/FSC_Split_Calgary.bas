...
Begin InputTables
    ...
    Name ="comm_configure"
    Name ="comm_salesperson_territory_split_CALGY"
End
Begin OutputColumns
    Expression ="comm_transaction.fiscal_yearmo_num"
    Expression ="comm_transaction.salesperson_key_id"
    Expression ="comm_salesperson_territory_split_CALGY.TransferFrom_cd"
...
Begin Joins
    ...
    Flag =1
    LeftTable ="comm_transaction"
    RightTable ="comm_salesperson_territory_split_CALGY"
    Expression ="comm_transaction.hsi_shipto_id = comm_salesperson_territory_split_CALGY.Shipto"
    Flag =1
End
Begin OrderBy
    Expression ="comm_salesperson_territory_split_CALGY.TransferFrom_cd"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="comm_salesperson_territory_split_CALGY.TransferFrom_cd"
