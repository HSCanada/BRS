...
Where ="(((comm_transaction.item_comm_group_cd)=\"SPMEQU\") AND ((comm_transaction.comm_"
    "plan_id) Like \"FSCG*\") AND ((comm_transaction.source_cd) In (\"JDE\")) AND ((c"
    "omm_transaction.customer_comm_group_cd)=\"CUSINS\") AND ((comm_transaction.vpa_c"
    "d)<>\"RID01\"))"
Begin InputTables
    Name ="comm_configure"
...
Begin OutputColumns
    ...
    Expression ="[gp_ext_amt]*([comm_base_rt]/100)"
End
Begin Joins
