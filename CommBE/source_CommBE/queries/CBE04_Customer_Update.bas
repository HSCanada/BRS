...
Where ="(((comm_customer_master.hsi_billto_id)<>comm_customer_hsi_stage!hsi_billto_id)) "
    ...
    "hsi_territory_cd)) Or (((comm_customer_master.ship_postal_num)<>Nz(comm_customer"
    "_hsi_stage!ship_postal_num,\"\"))) Or (((comm_customer_master.sales_plan_cd)<>Nz"
    "([Current_Sales_Plan_cd],\"0\")))"
Begin InputTables
