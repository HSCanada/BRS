...
Begin OutputColumns
    ...
    Expression ="comm_ess_statement_export.FRESEQ_GP_LYM_AMT"
    Expression ="comm_ess_statement_export.FRESEQ_GP_LYTD_AMT"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="comm_ess_statement_export.FRESEQ_GP_LYM_AMT"
        dbInteger "ColumnWidth" ="2475"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_ess_statement_export.FRESEQ_GP_LYTD_AMT"
