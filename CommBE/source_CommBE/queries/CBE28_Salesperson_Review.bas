...
dbMemo "OrderBy" ="[CBE28_Salesperson_Review].[select_ind] DESC, [CBE28_Salesperson_Review].[salesp"
    "erson_key_id], [CBE28_Salesperson_Review].[salesperson_nm], [CBE28_Salesperson_R"
    "eview].[employee_num], [CBE28_Salesperson_Review].[territory_start_dt], [CBE28_S"
    "alesperson_Review].[comm_plan_id], [CBE28_Salesperson_Review].[master_salesperso"
    "n_cd]"
