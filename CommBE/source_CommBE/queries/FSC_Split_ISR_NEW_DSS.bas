Operation =1
Option =0
Where ="(((comm_transaction_ts.FiscalMonth) Between 201701 And 201703) AND ((comm_transa"
    "ction_ts.ess_salesperson_cd)=\"DSS01\") AND ((comm_transaction_ts.salesperson_ke"
    "y_id)<>\"Internal\"))"
Begin InputTables
