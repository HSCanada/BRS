...
Begin OutputColumns
    ...
    Alias ="DIGCCC_SALES_CM_AMT"
    Expression ="0"
    Alias ="DIGCCC_SALES_LYM_AMT"
    Expression ="0"
    Alias ="DIGCCC_GP_CM_AMT"
    Expression ="0"
    Alias ="DIGCCC_SALES_YTD_AMT"
    Expression ="0"
    Alias ="DIGCCC_GP_YTD_AMT"
    Expression ="0"
    Alias ="DIGCCC_SALES_LYTD_AMT"
    Expression ="0"
    Alias ="DIGCCC_GOAL_YTD_AMT"
    Expression ="0"
    Alias ="DIGCCC_GP_LYM_AMT"
    Expression ="0"
    Alias ="DIGCCC_GP_LYTD_AMT"
    Expression ="0"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="DIGCCC_GP_LYTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCCC_SALES_CM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCCC_SALES_LYM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCCC_GP_CM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCCC_SALES_YTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCCC_GP_YTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCCC_SALES_LYTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
