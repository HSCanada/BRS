Operation =1
Option =0
Where ="(((comm_transaction.fiscal_yearmo_num)>=\"201701\") AND ((comm_transaction.sales"
    "person_key_id)<>\"Internal\") AND ((comm_transaction.item_comm_group_cd)=\"DIGMA"
    "T\") AND ((comm_transaction.IMCLMJ) In (\"372\",\"318\")))"
Begin InputTables
