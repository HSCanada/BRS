...
Begin OutputColumns
    ...
    Expression ="0"
    Expression ="comm_statement_export.DIGCIM_SALES_CM_AMT"
    Expression ="comm_statement_export.DIGCIM_SALES_LYM_AMT"
    Expression ="comm_statement_export.DIGCIM_GP_CM_AMT"
    Expression ="comm_statement_export.DIGCIM_COMM_CM_AMT"
    Expression ="comm_statement_export.DIGCIM_SALES_YTD_AMT"
    Expression ="comm_statement_export.DIGCIM_GP_YTD_AMT"
    Expression ="comm_statement_export.DIGCIM_SALES_LYTD_AMT"
    Alias ="DIGCIM_GOAL_YTD_AMT"
    Expression ="0"
    ...
    Expression ="comm_statement_export.DIGCIM_GP_LYM_AMT"
    Expression ="comm_statement_export.DIGCIM_GP_LYTD_AMT"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_SALES_CM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_SALES_LYM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_GP_CM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_COMM_CM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_SALES_YTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_GP_YTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_SALES_LYTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="DIGCIM_GOAL_YTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_GP_LYM_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="comm_statement_export.DIGCIM_GP_LYTD_AMT"
        dbLong "AggregateType" ="-1"
    End
    Begin
