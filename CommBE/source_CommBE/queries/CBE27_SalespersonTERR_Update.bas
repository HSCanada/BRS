...
dbMemo "OrderBy" ="[CBE27_SalespersonTERR_Update].[DST_comm_plan_id], [CBE27_SalespersonTERR_Update"
    "].[DST_salesperson], [CBE27_SalespersonTERR_Update].[SRC_comm_plan_id]"
Begin
    Begin
