Operation =1
Option =0
Where ="(((comm_salesperson_code_map.branch_cd) In (\"MNTRL\",\"QUEBC\")) AND ((comm_tra"
    "nsaction.source_cd)=\"JDE\") AND ((comm_transaction.salesperson_key_id)<>\"Inter"
    "nal\") AND ((comm_transaction.IMCLMJ) In (\"856\",\"X11\",\"857\",\"858\",\"X17\""
    ")) AND ((comm_transaction.manufact_cd) Not In (\"BIOLAS\",\"IMASCI\")))"
Begin InputTables
    Name ="comm_configure"
