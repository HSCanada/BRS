Operation =1
Option =0
Where ="(((comm_salesperson_master.comm_plan_id)=\"ESSP00\") AND ((comm_salesperson_mast"
    "er.esend_setup_ind)=True)) OR (((comm_salesperson_master.comm_plan_id)=\"FSCDP00"
    "\") AND ((comm_salesperson_master.esend_setup_ind)=True))"
Begin InputTables
